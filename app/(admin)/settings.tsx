    ...
    const settingsSections = [
        ...
        },
        {
            ...
            items: [
                ...
                { icon: 'shield-checkmark-outline', label: 'Security & Privacy', type: 'link' },
                { icon: 'document-text-outline', label: 'Terms & Conditions', type: 'link' },
            ],
        },
        {
            title: 'System',
            items: [
                ...
                { icon: 'cloud-upload-outline', label: 'Backup & Restore', type: 'link' },
