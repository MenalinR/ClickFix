        ...
        <SafeAreaView style={styles.container}>
            ...
            >
                {[
                    ...
                    <TouchableOpacity
                        key={filter.key}
                        style={[styles.filterChip, filterStatus === filter.key && styles.activeChip]}
                        onPress={() => setFilterStatus(filter.key as any)}
                    >
                        <Text style={[styles.filterLabel, filterStatus === filter.key && styles.activeLabel]}>
                            {filter.label}
                        </Text>
                        <View style={[styles.badge, filterStatus === filter.key && styles.activeBadge]}>
                            <Text style={[styles.badgeText, filterStatus === filter.key && styles.activeBadgeText]}>
                                {filter.count}
                            </Text>
                        </View>
                    </TouchableOpacity>
                        ...
                        <View key={booking.id} style={styles.bookingCard}>
                            ...
                            <View style={styles.bookingDetails}>
                                <View style={styles.detailRow}>
                                    ...
                                    <Text style={styles.detailText}>Customer: {booking.customerName || 'N/A'}</Text>
                                </View>
                                <View style={styles.detailRow}>
                                    <Ionicons name="hammer-outline" size={16} color={Colors.textSecondary} />
                                    <Text style={styles.detailText}>Worker: {booking.workerName}</Text>
                                </View>
                                <View style={styles.detailRow}>
                                    <Ionicons name="briefcase-outline" size={16} color={Colors.textSecondary} />
                                    <Text style={styles.detailText}>Service: {booking.service}</Text>
                                </View>
                                <View style={styles.detailRow}>
                                    <Ionicons name="cash-outline" size={16} color={Colors.textSecondary} />
                                    <Text style={styles.detailText}>Amount: ${booking.amount || '0.00'}</Text>
                                </View>
                            </View>
