    ...
    <View style={styles.itemCard}>
      <View style={styles.itemHeader}>
        ...
        <View
          style={[
            styles.stockBadge,
            { backgroundColor: item.inStock ? "#4CAF50" : "#FF6B6B" },
          ]}
        >
      ...
      <View style={styles.itemActions}>
        <TouchableOpacity
          ...
          style={[
            styles.actionBtn,
            { backgroundColor: item.inStock ? "#FF9800" : "#4CAF50" },
          ]}
        >
          <Ionicons
    ...
    <View style={styles.requestCard}>
      ...
      <View style={styles.requestDetails}>
        <Text style={styles.requestLabel}>
          Worker: <Text style={styles.requestValue}>{item.workerId.name}</Text>
        </Text>
        <Text style={styles.requestLabel}>
          Customer:{" "}
          <Text style={styles.requestValue}>{item.customerId.name}</Text>
        </Text>
        <Text style={styles.requestLabel}>
          Total Cost:{" "}
        ...
        <Text style={styles.requestLabel}>
          Items:{" "}
          <Text style={styles.requestValue}>{item.items.length} item(s)</Text>
        </Text>
      </View>
      ...
      <View style={styles.tabs}>
        ...
        >
          <Ionicons
            ...
            size={20}
            color={
              activeTab === "inventory" ? Colors.primary : Colors.textSecondary
            }
          />
          <Text
            style={[
