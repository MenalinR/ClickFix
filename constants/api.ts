...
export const api = {
  ...
  jobs: {
    ...
    proposeReschedule: (id: string) =>
      `${API_URL}/jobs/${id}/reschedule/propose`,
    respondReschedule: (id: string) =>
      `${API_URL}/jobs/${id}/reschedule/respond`,
    ...
    confirmPayment: (id: string) => `${API_URL}/jobs/${id}/confirm-payment`,
  ...
  hardwareShop: {
    ...
    updateProfile: `${API_URL}/hardwareShop/profile`,
    ...
    clearLocation: `${API_URL}/hardwareShop/location`,
