...
export interface Job {
  ...
  // Extended properties for worker dashboard
  customerName?: string;
  serviceType?: string;
  location?: string;
...
const MOCK_WORKERS: Worker[] = [
  {
    ...
    location: "Colombo 03",
    about:
      "Experienced plumber with over 10 years in residential repairs. Specialist in leak detection and pipe fitting.",
    reviews: [
      { id: "r1", user: "Kamal", text: "Great service, very fast!", rating: 5 },
      {
        id: "r2",
        user: "Sunil",
        text: "Fixed the leak but came a bit late.",
        rating: 4,
      },
    ],
  },
  {
    ...
    location: "Dehiwala",
    about:
      "Certified industrial and residential electrician. Safety first guaranteed.",
    reviews: [
